...
class DisDetailsBarcode extends StatelessWidget {
  final String barcode;

  DisDetailsBarcode(this.barcode);

  @override
  Widget build(BuildContext context) {
    Future<List<dynamic>> _results = Collection.barcode(barcode);
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text("Barcode Results", style: TextStyle(color: Colors.black)),
          actions: [
            TextButton(
                onPressed: () {
                  showDialog(
