...
class SpotAddButton extends StatefulWidget {
  Future<List<dynamic>> input;
  String albumID;
  //const AddAlbumPopUp({Key? key}) : super(key: key);

  SpotAddButton(this.input, this.albumID);

  @override
  State<SpotAddButton> createState() => _SpotAddButtonState(albumID);
}

class _SpotAddButtonState extends State<SpotAddButton> {
  ...
  _SpotAddButtonState(this.albumID);
