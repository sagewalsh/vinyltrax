...
import 'package:applevinyltrax/show_data/genreList.dart';
import 'package:applevinyltrax/inventory/getAlbums.dart';
import 'package:applevinyltrax/show_data/categories.dart';
                  ...
                  Container(
                    ...
                    child: DropdownButton(
                        ...
                        onChanged: (type) async {
                          ...
                          prefs
                              .setString('order', (type as _Order).name)
                              .then((bool success) {
                            setState(() {
                              _selectedOrder = type;
                            });
                  ...
                  Container(
                    ...
                    child: DropdownButton(
                        ...
                        onChanged: (type) async {
                          final SharedPreferences prefs = await _prefs;
                          prefs
                              .setString('type', (type as Type).name)
                              .then((bool success) {
                            setState(() {
                              _selectedType = type;
                            });
