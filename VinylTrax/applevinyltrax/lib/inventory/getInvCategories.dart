...
import 'package:applevinyltrax/show_data/icon.dart';

class GetInvCategories extends StatelessWidget {
  final String category;
  final String format;

  GetInvCategories(this.category, this.format);

  @override
  Widget build(BuildContext context) {
    final Future<List<List<dynamic>>> _results =
        Database.displayByCategory(category, format);
    return SizedBox(
